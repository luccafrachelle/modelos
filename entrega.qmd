...
```{r, fig.cap = "Distribución y Correlación"}
#| label: fig-plot0 
#| echo: false
ggpairs(df)
```
...
```{r,fig.cap = "Normalidad de los residuos"}
#| echo: false
#|label: fig-plot0 
...
plot(density(rstudent(mod)))
```
```{r, fig.cap = "Comparación de los cuantiles teóricos y empíricos" }
#| echo: false
#| label: fig-plot0 
n <- nrow(df)
z_i <- qnorm(seq(n)/(n + 1))
